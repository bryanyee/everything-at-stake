...
export default function WhyCardano() {
  return (
    <Layout date={page.date} title={page.title}>
      ...
      <p><strong>Problem case (paying fees for failed transactions):</strong> Earlier in October 2021, an <ExternalLink href="https://www.theblockcrypto.com/post/120438/ethereum-user-pays-430000-in-transaction-fees-for-a-failed-payment">Ethereum user spent $430,000 in fees for a transaction that ultimately failed</ExternalLink>.</p>
      ...
      <p><strong>Problem case (exploiting global state):</strong> The <ExternalLink href="https://www.gemini.com/cryptopedia/the-dao-hack-makerdao">DAO hack of 2016 resulted in the hard fork of Ethereum</ExternalLink>, reversing transactions, and splitting off a separate blockchain, Ethereum Classic.</p>
