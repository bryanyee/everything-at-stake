  ...
  return (
    <Layout date={page.date} title={page.title}>
      <HighlightBox className="mb-3">
        <strong>Note:</strong> The target audience for this article are those who have already set up a cardano node. There are essentially <strong><em>only two CLI commands</em></strong> used in this process - one to view UTxOs and one to submit the vote transaction. Several fixes for potential issues are also listed below. If you‘d like to jump right in, <a href="#steps-to-vote">start here!</a>
      </HighlightBox>
...
f23b74be2d190b6b5e2e56a5d8157d497ed5e38cef7fa380a025e516e99b9bb5     0        8168049 lovelace + TxOutDatumHashNone
      ...
      <p>Value for the <strong><em>my_utxo</em></strong> arg in the script, in this example: <strong>f23b74be2d190b6b5e2e56a5d8157d497ed5e38cef7fa380a025e516e99b9bb5#0</strong>
      </p>
...
`}
      ...
      <p>
        In this example, the transaction value used for the <strong><em>lobster_script_utxo</em></strong> arg in the script will be: <strong>d227fc044c2c4f9f89c3c0c75069e12e50ad4e1642734311af0faf0fc3957d4f#1</strong>
      </p>
...
`}
      ...
      <p>If the transaction is submited correctly, wait ~30sec and re-query the script address to see the new UTxO.</p>
      <p>
