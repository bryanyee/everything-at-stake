...
const page = findPage('the-cardano-bull-case-fall-2021');

export default function TheCardanoBullCaseFall2021() {
  return (
    <Layout date={page.date} title={page.title}>
      ...
      <ul>
        ...
        <li><strong>(M) Medium impact</strong>: These announcements and project developments are also news-worthy in the crypto world.</li>
        <li><strong>(L) Low impact</strong>: These are great news items within the Cardano community. Collectively, there‘ll all postive signs for Cardano.</li>
      </ul>
      <p>Italicized items are actual titles of sessions at Cardano Summit.</p>
      <h3 className="mt-5">Cardano Summit Events and Rumors</h3>
      <ul>
        <li><strong><em>Government partnerships</em></strong></li>
          <ul>
            ...
            <li>(H) (rumor) Announcement for Cardano serving as the platform for the 2022 Wyoming state elections</li>
          </ul>
        <li><strong><em>Corporate partnerships</em></strong></li>
        <ul>
          <li>(H) (rumor) Extremely speculative rumors about a large corporate partnership, such as with Amazon or Apple</li>
        </ul>
        <li><strong><em>Apps & functionality</em></strong></li>
        <ul>
          <li>(M) Coti payments platform: a practical payments application for end users</li>
          <li>(M) SingularityNET: decentralized network and market for AI applications and services</li>
          <li>(M) World Mobile Token: decentralized network bringing internet access to unconnected communities</li>
          <li>(L) Ergo partnership for decentralized exchange and oracle projects</li>
          <li>(L) Atala Prism: identity solution</li>
          <li>(L) <em>CryptoBisons: gaming with Cardano NFTs</em></li>
        </ul>
        <li><strong><em>Platform</em></strong></li>
        <ul>
          <li>(M) Plutus dApp store: app store for discovery of Cardano-based apps</li>
          <li>(M) Cardano Certification program: certifications and auditing to give users assurance about the integrity of the dApps</li>
          <li>(M) <em>Hydra: a new era for scalability in Cardano</em></li>
          <li>(L) <em>Babel fees: paying transaction fees with custom currencies</em> (paying fees w/ tokens other than Ada)</li>
          <li>(M) Marlowe DSL for financial contracts</li>
        </ul>
      </ul>
      <p className="mt-3">The above items stood out to me the most. Below are additional interesting titles for sessions at Cardano Summit. Each of these are positive news for Cardano in general; it‘s just absurd that they‘re all going to potentially be a part of the news cycle within the span of a couple days.</p>
      <ul>
        <li>Wall Street & the UN Sustainable Development Goals</li>
        <li>Panel: RealFi – opening up opportunity for everyone</li>
        ...
        <li>How regulated capital is adopting cryptocurrencies</li>
        <li>Charles & special music guest talk NFTs for good</li>
        <li>Djed: a formally verified algorithmic crypto-backed stablecoin protocol</li>
        <li>Wolfram: the art of science</li>
        <li>Bitpoint: ada and the Japanese exchange future</li>
        <li>EMURGO: investing in Cardano‘s future</li>
        <li>Anti-maximalism: collaboration for industry growth</li>
